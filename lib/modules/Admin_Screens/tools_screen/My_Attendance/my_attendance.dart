    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        if (snapshot.hasData) {
          return Scaffold(
            appBar: AppBar(
              title: Text(context.tr('myAttendance')), // Use context.tr()
            ),
            body: Padding(
                        ...
                        Container(
                          ...
                          child: GestureDetector(
                            onTap: () {
                              showDialog(
                                context: context,
                                builder: (_) => BlocConsumer<AppLoginCubit, AppLoginStates>(
                                          ...
                                          builder: (context) {
                                            return Container(
                                              ...
                                              child: Column(
                                                children: [
                                                  Text(
                                                    context.tr('pickDay'), // Use context.tr()
                                                    style: TextStyle(
                                                      color: AppCubit.get(context).isDark
                                                          ? Colors.white
                                                          : HexColor('333739'),
                                                  ...
                                                  defaultTextFormFieldM(
                                                    ...
                                                    obscureText: false,
                                                    label: context.tr('pickDay'), // Use context.tr()
                                                    prefixIcon: Iconsax.calendar_add,
                                                    keyboardType: TextInputType.text,
                                                    validator: (value) {
                                                      if (value!.isEmpty) {
                                                        return context.tr('daymustntbeEmpty'); // Use context.tr()
                                                      } else {
                                                        return null;
                                                      }
                                                    },
                                        ...
                                        children: [
                                          Expanded(
                                            child: Column(
                                              children: [
                                                Text(
                                                  context.tr('checkIn'), // Use context.tr()
                                                  style: TextStyle(
                                                    color: AppCubit.get(context).isDark
                                                        ? Colors.white
                                                        : HexColor('333739'),
                                                ...
                                                Text(
                                                  snapshot.data!.docs[index]['Check In'],
                                                  style: TextStyle(
                                                    fontWeight: FontWeight.w500,
                                                    color: AppCubit.get(context).isDark
                                                        ? Colors.white
                                                ...
                                                Container(
                                                  child: GestureDetector(
                                                    onTap: () {
                                                      openMap(snapshot.data!.docs[index]['LocationCheckIn']);
                                                    },
                                                    child: Padding(
                                                      padding: const EdgeInsets.all(4.0),
                                                      child: Text(
                                                        context.tr('checkInLocation'), // Use context.tr()
                                                        style: TextStyle(
                                                          fontWeight: FontWeight.w500,
                                                          color: AppCubit.get(context).isDark
                                                              ? HexColor('333739')
                                          ...
                                          Expanded(
                                            child: Column(
                                              children: [
                                                Text(
                                                  context.tr('checkOut'), // Use context.tr()
                                                  style: TextStyle(
                                                    color: AppCubit.get(context).isDark
                                                        ? Colors.white
                                                        : HexColor('333739'),
                                                ...
                                                Text(
                                                  snapshot.data!.docs[index]['Check Out'],
                                                  style: TextStyle(
                                                    color: AppCubit.get(context).isDark
                                                        ? Colors.white
                                                        : HexColor('333739'),
                                                ...
                                                Container(
                                                  child: GestureDetector(
                                                    onTap: () {
                                                      openMap(snapshot.data!.docs[index]['LocationCheckOut']);
                                                    },
                                                    child: Padding(
                                                      padding: const EdgeInsets.all(4.0),
                                                      child: Text(
                                                        context.tr('checkOutLocation'), // Use context.tr()
                                                        style: TextStyle(
                                                          color: AppCubit.get(context).isDark
                                                              ? HexColor('333739')
                                                              : Colors.white,
