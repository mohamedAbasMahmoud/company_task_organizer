    ...
    return StreamBuilder(
        ...
        builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
          if (snapshot.hasData) {
            return Scaffold(
              appBar: AppBar(
                title: Text('companyMissionsDetails'.tr()),
              ),
              body: Padding(
                  ...
                  child: Column(
                    children: [
                          ...
                          Row(
                            children: [
                              ...
                              Container(
                                width: 200,
                                child: SelectableText(
                                  snapshot.data!.docs[taskIndex][KGiveMissionFire],
                                  style: Theme.of(context).textTheme.bodyLarge,
                                ),
                              ),
                            ],
                          ...
                          Row(
                            children: [
                              ...
                              Container(
                                ...
                                child: SelectableText(
                                  snapshot.data!.docs[taskIndex][KReportFire]
                                          .toString()
                                          .isEmpty
                                      ? snapshot.data!.docs[taskIndex][KFailedFire]
                                      : snapshot.data!.docs[taskIndex][KReportFire],
                                  style: Theme.of(context).textTheme.bodyLarge,
                                ),
                              ),
                              editButton(
                                ...
                                field: snapshot.data!.docs[taskIndex][KReportFire].isEmpty
                                    ? KFailedFire
                                    : KReportFire,
                                context: context,
                              ),
                      ...
                      snapshot.data!.docs[taskIndex]['image_url']
                              .toString()
                              .isNotEmpty
                          ? Text('details'.tr(), style: Theme.of(context).textTheme.bodyLarge)
                          : SizedBox(),
                      SizedBox(height: 25),
                      snapshot.data!.docs[taskIndex]['image_url']
                              .toString()
                              .isNotEmpty
                          ? Image.network(snapshot.data!.docs[taskIndex]['image_url'])
                          : SizedBox(),
                      SizedBox(height: 25),
                      snapshot.data!.docs[taskIndex]['image_d_url']
                              .toString()
                              .isNotEmpty
                          ? Text('report'.tr(), style: Theme.of(context).textTheme.bodyLarge)
                          : SizedBox(),
                      ...
                      snapshot.data!.docs[taskIndex]['image_d_url']
                              .toString()
                              .isNotEmpty
                          ? Image.network(snapshot.data!.docs[taskIndex]['image_d_url'])
                          : SizedBox(),
                      snapshot.data!.docs[taskIndex]['image_f_url']
                              .toString()
                              .isNotEmpty
                          ? Image.network(snapshot.data!.docs[taskIndex]['image_f_url'])
                          : SizedBox(),
                    ],
                  ),
                ),
